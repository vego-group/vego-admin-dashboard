...
import { mockTopDrivers } from '@/lib/mock-data';
...
export function TopDriversLeaderboard() {
          ...
          <li key={driver.name}>
            ...
            <div className="mt-2 ms-10 flex items-center gap-2">
              <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
                <div
                  className={cn('h-full rounded-full', barColors[idx])}
